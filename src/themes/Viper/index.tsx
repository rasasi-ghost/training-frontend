...
function Main() {
  ...
  return (
    <div
      className={clsx([
        "viper",
        "before:content-[''] before:z-[-1] before:w-screen before:bg-slate-50 before:top-0 before:h-screen before:fixed dark:before:bg-darkmode-800",
      ])}
    >
      <div
        className={clsx([
      ...
      >
        <div className="fixed top-0 inset-x-0 z-10 h-[65px] box bg-slate-50 border-x-0 border-t-0 rounded-none flex shadow-none">
          <div
            className={clsx([
              "xl:bg-slate-100 flex-none flex items-center z-10 px-5 h-full xl:w-[275px] overflow-hidden relative duration-300 group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000001f] dark:xl:bg-darkmode-600",
              "before:content-[''] before:hidden before:xl:block before:absolute before:right-0 before:border-r before:border-slate-300/50 before:h-full",
            ])}
            onMouseOver={(event) => {
              event.preventDefault();
          ...
          <div className="absolute transition-[padding] duration-100 xl:pl-[275px] group-[.side-menu--collapsed]:xl:pl-[91px] h-full inset-x-0">
            <div className="flex items-center w-full h-full px-5">
              ...
              >
                <div className="bg-slate-100 border w-[350px] flex items-center py-2 px-3.5 rounded-[0.5rem] text-slate-400 cursor-pointer hover:bg-slate-50 transition-colors dark:bg-black/20">
                  <Lucide icon="Search" className="w-[18px] h-[18px]" />
        ...
        >
          <div
            className={clsx([
              "xl:ml-0 bg-slate-100 border-r border-slate-300/50 rounded-none w-[275px] duration-300 transition-[width,margin] group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-solid relative overflow-hidden h-full flex flex-col dark:bg-darkmode-800",
